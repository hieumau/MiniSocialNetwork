...
//    private static final String SUCCESS = ViewArticleDetailController.class.getSimpleName();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Comments comment =  commentBLO.get(commentId);
            int articleId = comment.getArticleId().getArticleId();

            //check right people
            if (user.getUserId().equals(comment.getUserId().getUserId())){
                commentBLO.delete(commentId);
